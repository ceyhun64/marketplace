...
namespace api.Migrations
{
    ...
    [Migration("20260608093419_AddCustomerWithdrawalRequests")]
    partial class AddCustomerWithdrawalRequests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Domain.Entities.AnnouncementItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("api.Domain.Entities.Coupon", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("api.Domain.Entities.CustomerTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("api.Domain.Entities.CustomerWithdrawalRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CustomerWithdrawalRequests");
                });
            ...
            modelBuilder.Entity("api.Domain.Entities.HeroSettings", b =>
                {
                    ...
                    b.Property<string>("HeadlineAccent")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("api.Domain.Entities.MerchantWallet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("api.Domain.Entities.OrderItem", b =>
                {
                    ...
                    b.Property<Dictionary<string, string>>("VariantAttributes")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("api.Domain.Entities.ProductQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("AnsweredByMerchantId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AnsweredByMerchantId");
            ...
            modelBuilder.Entity("api.Domain.Entities.Referral", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("api.Domain.Entities.VendorOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("api.Domain.Entities.WalletTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("PendingBefore")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("api.Domain.Entities.OrderItem", b =>
                {
                    ...
                    b.HasOne("api.Domain.Entities.ProductVariant", "Variant")
                        .WithMany()
            ...
            modelBuilder.Entity("api.Domain.Entities.ProductQuestion", b =>
                {
                    b.HasOne("api.Domain.Entities.MerchantProfile", "AnsweredByMerchant")
                        .WithMany()
                        .HasForeignKey("AnsweredByMerchantId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("AnsweredByMerchant");
            ...
            modelBuilder.Entity("api.Domain.Entities.Referral", b =>
                {
                    b.HasOne("api.Domain.Entities.User", "ReferredUser")
                        .WithMany()
                        .HasForeignKey("ReferredUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("api.Domain.Entities.User", "Referrer")
                        .WithMany()
