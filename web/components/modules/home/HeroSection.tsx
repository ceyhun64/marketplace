...
import {
  Search, Truck, Store, ChevronRight, ArrowRight,
} from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div style={{ position: "absolute", inset: 0, pointerEvents: "none", overflow: "hidden" }}>
        <div style={{ position:"absolute", top:"-10%", right:"-5%", width:"45%", height:"70%",
          background:"radial-gradient(ellipse, rgba(200,16,46,0.04) 0%, transparent 70%)" }} />
        <div style={{ position:"absolute", bottom:"-10%", left:"-5%", width:"35%", height:"50%",
          background:"radial-gradient(ellipse, rgba(51,51,51,0.04) 0%, transparent 70%)" }} />
        <div style={{ position:"absolute", top:0, left:0, right:0, height:1,
          background:"var(--border-light)" }} />
      </div>

      <div style={{ position:"relative", maxWidth:1300, margin:"0 auto", padding:"0 2rem", width:"100%" }}>
        <div
        ...
        >
          ...
          <div style={{ zIndex: 10 }}>
            ...
            {hero.badgeText && (
              <div style={{
                ...
                border:"1px solid var(--red-subtle)", borderRadius:999,
              ...
              {headlineLines.map((line, i) => {
                ...
                if (accentWord && line.includes(accentWord)) {
                  ...
                  return (
                    <span key={i}>
                      {parts[0]}
                      <em style={{ color:"var(--red)", fontStyle:"italic" }}>{accentWord}</em>
            ...
            <p style={{
              ...
              color:"var(--charcoal-soft)", lineHeight:1.8,
            ...
            {/* Search form */}
            <form onSubmit={handleSearch} style={{ marginBottom:"2rem", maxWidth:500 }}>
              <div
                style={{
              ...
              >
                <Search style={{ color:"var(--charcoal-soft)", flexShrink:0, marginRight:8 }} size={16} strokeWidth={2} />
                <input
                  type="text"
                  value={query}
                ...
                <button
                  ...
                  style={{
                    ...
                    flexShrink:0, boxShadow:"0 2px 8px rgba(200,16,46,0.25)",
                ...
                {hero.tags.map((tag) => (
                  <Link
                    ...
                    style={{
                      ...
                      fontWeight:500, color:"var(--charcoal-soft)",
          ...
          >
            <div style={{
              ...
              background:"var(--off-white-2)", border:"1px solid var(--border-light)",
            }} />

            {/* Main product card */}
            <div style={{
              position:"relative", width:320, background:"var(--white)",
              borderRadius:24, boxShadow:"var(--shadow-lg)",
              border:"1px solid var(--border-light)", overflow:"hidden", zIndex:20,
            }}>
              <div style={{ height:3, background:"var(--red)" }} />
              <div style={{
                height:180,
                background:"linear-gradient(135deg, var(--off-white) 0%, var(--off-white-2) 100%)",
              ...
              <div style={{ padding:"1.5rem" }}>
                <div style={{
                  ...
                  color:"var(--red)", marginBottom:"0.375rem",
                }}>Best Offer</div>
                <div style={{
                  fontFamily:"var(--font-display)", fontSize:"1.25rem",
                  fontWeight:500, color:"var(--charcoal)", marginBottom:"1rem",
                }}>iPhone 15 Pro</div>
                <div style={{
                  display:"flex", alignItems:"center", justifyContent:"space-between",
                  paddingTop:"1rem", borderTop:"1px solid var(--border-light)",
                }}>
                  <div style={{ fontFamily:"var(--font-display)", fontSize:"1.5rem", fontWeight:500, color:"var(--charcoal)" }}>₺72,499</div>
                  <Link href="/flash-sale" style={{
            ...
            <div className="animate-float" style={{
              ...
              borderRadius:16, padding:"1rem 1.25rem", boxShadow:"var(--shadow-md)",
              minWidth:210, animationDelay:"0s",
            }}>
              <div style={{ display:"flex", alignItems:"center", gap:"0.75rem" }}>
                <div style={{
                  width:38, height:38, background:"var(--charcoal)", borderRadius:10,
                  display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0,
                }}>
                  <Truck size={16} color="white" />
                </div>
                <div>
                  <div style={{ fontFamily:"var(--font-mono)", fontSize:"0.625rem", color:"var(--charcoal-soft)", letterSpacing:"0.1em", textTransform:"uppercase" as const, marginBottom:2 }}>Courier en route</div>
                  <div style={{ fontFamily:"var(--font-body)", fontSize:"0.75rem", fontWeight:700, color:"var(--charcoal)" }}>Arriving in 3 mins</div>
                  <div style={{ width:"100%", background:"var(--off-white-2)", height:3, borderRadius:999, marginTop:6, overflow:"hidden" }}>
                    <div style={{ width:"75%", height:"100%", background:"var(--red)", borderRadius:999 }} />
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Store float card */}
            <Link href="/auth/apply-merchant" className="animate-float" style={{
              position:"absolute", bottom:60, left:-20, zIndex:30,
              background:"var(--white)", border:"1px solid var(--border-light)",
              borderRadius:16, padding:"1rem 1.25rem", boxShadow:"var(--shadow-md)",
              transform:"rotate(-2deg)", animationDelay:"1.5s",
              textDecoration:"none", display:"block",
            }}>
              <div style={{ display:"flex", alignItems:"center", gap:"0.75rem" }}>
                <div style={{
                  width:38, height:38, background:"var(--red-muted)", borderRadius:10,
                  display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0,
                }}>
                  <Store size={16} color="var(--red)" />
                </div>
                <div>
                  <div style={{ fontFamily:"var(--font-mono)", fontSize:"0.625rem", color:"var(--charcoal-soft)", letterSpacing:"0.1em", textTransform:"uppercase" as const, marginBottom:2 }}>Seller Panel</div>
                  <div style={{ fontFamily:"var(--font-body)", fontSize:"0.75rem", fontWeight:700, color:"var(--charcoal)" }}>Open Your Store</div>
                </div>
...
function HeroSkeleton() {
  return (
    ...
    >
      <div style={{ maxWidth: 1300, margin: "0 auto", padding: "0 2rem", width: "100%" }}>
        <div
          style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }}
          className="lg:grid-cols-2 grid-cols-1"
        >
          ...
          <div className="hidden lg:flex items-center justify-center" style={{ height: 520 }}>
