...
// useSearchParams() Suspense boundary gerektiriyor — ayrı bileşene alındı
function LoginForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 py-12">
      ...
      <div className="w-full max-w-[460px] relative">
        {/* Suspense: useSearchParams() için zorunlu */}
        <Suspense
          fallback={
            <div className="bg-white/80 backdrop-blur-xl border border-black/[0.03] rounded-[40px] p-8 md:p-12 h-[480px] animate-pulse" />
          }
        >
          <LoginForm />
        </Suspense>
