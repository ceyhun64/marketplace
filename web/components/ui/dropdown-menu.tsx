  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        align={align}
        className={cn(
          "z-50 min-w-48 overflow-hidden rounded-[var(--radius-lg)] bg-white p-1.5 text-[var(--charcoal)] shadow-[var(--shadow-lg)] ring-1 ring-[var(--border-light)] duration-[var(--dur-fast)]",
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "data-inset:pl-9.5",
        "data-[variant=destructive]:text-[var(--red)] data-[variant=destructive]:focus:bg-[var(--red-muted)] data-[variant=destructive]:data-[highlighted]:bg-[var(--red-muted)] data-[variant=destructive]:data-[highlighted]:text-[var(--red)]",
    ...
    >
      ...
      >
        <DropdownMenuPrimitive.ItemIndicator>
          <CheckIcon className="size-3.5 text-[var(--red)]" />
        </DropdownMenuPrimitive.ItemIndicator>
      </span>
      {children}
    </DropdownMenuPrimitive.CheckboxItem>
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        "px-3 py-2 text-xs font-mono text-[var(--charcoal-soft)] tracking-wider uppercase data-inset:pl-9.5",
        className,
      )}
      {...props}
    />
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ml-auto font-mono text-xs tracking-widest text-[var(--charcoal-mist)]",
        className,
      )}
      {...props}
    />
...
function DropdownMenuSubTrigger({
  ...
  return (
    ...
    >
      {children}
      <ChevronRightIcon className="ml-auto size-4 text-[var(--charcoal-soft)]" />
    </DropdownMenuPrimitive.SubTrigger>
  );
}
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        "z-50 min-w-36 overflow-hidden rounded-[var(--radius-lg)] bg-white p-1.5 text-[var(--charcoal)] shadow-[var(--shadow-lg)] ring-1 ring-[var(--border-light)] duration-[var(--dur-fast)]",
        "data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95",
        "data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95",
        className,
      )}
